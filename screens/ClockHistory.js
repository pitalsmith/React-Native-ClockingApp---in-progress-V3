...
import { SafeAreaView, Text, View, Button, TextInput, FlatList } from 'react-native';
      ...
      <View className="flex-1 justify-center items-center bg-pink-500 font-bold ">
        <View className="mt-10 flex space-y-4 mb-20">
          <View className='items-center'>
            <Text className="font-bold items-center">Clock History For : {username} </Text>
          </View>
          <View>
          ...
          <Text> Date: {item.ClockIn}</Text>
          <Text> Date: {item.ClockOut}</Text>
          </View>
